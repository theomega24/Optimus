package me.notom3ga.optimus.alerts;
...
public class AlertManager {
    ...
    public void alert(Player player, CheckInfo check, int vl) {
        ...
        TextComponent alert = LegacyComponentSerializer.legacyAmpersand().deserialize(format);
